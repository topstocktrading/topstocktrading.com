...
(function() {
  ...
  // Detect password recovery token in URL and show reset form
  function checkForPasswordRecovery() {
    ...
    // Supabase auth listener fires PASSWORD_RECOVERY event when this hash is present
  ...
  function showPasswordResetForm() {
    ...
    overlay.innerHTML =
      '<div style="max-width:400px;width:90%;background:#111712;border:1px solid #1e2820;border-radius:16px;padding:40px 32px;">' +
        ...
        '<div style="font-size:13px;color:#6b7c6e;margin-bottom:24px;line-height:1.6;">Enter a new password for your TST Academy account.</div>' +
    ...
    document.getElementById('submit-new-password').onclick = async function() {
      ...
      overlay.innerHTML =
        '<div style="max-width:400px;width:90%;background:#111712;border:1px solid #1e2820;border-radius:16px;padding:40px 32px;text-align:center;">' +
          '<div style="font-size:40px;margin-bottom:16px;">✓</div>' +
          '<div style="font-family:Rajdhani,sans-serif;font-size:22px;font-weight:700;color:#f0f4f1;margin-bottom:8px;">Password Updated</div>' +
          '<div style="font-size:13px;color:#6b7c6e;">You can now log in with your new password.</div>' +
        '</div>';
